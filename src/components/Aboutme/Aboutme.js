    ...
    <div id='abtParent'>
            ...
            <div id='abtp'>
                <p id="aboutMe">
                    ...
                    library, I wanted to be efficient. I am versed in: <ul><li>JavaScript</li> <li>CSS</li> <li>HTML</li> <li>Jquery</li> <li>React</li> <li>Handlebars</li> <li>NodeJS</li> <li>MySQL</li> <li>Sequelize</li> 
